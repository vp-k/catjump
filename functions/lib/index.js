...
exports.verifyIAPPurchase = exports.sendDailyRewardPush = exports.sendStreakDangerPush = exports.processScheduledPushes = exports.scheduleEnergyFullPush = exports.sendD7D14RetentionPush = exports.sendD3D5RetentionPush = exports.sendD1RetentionPush = exports.resetWeeklyLeaderboard = exports.updateLeaderboard = exports.cleanupIdempotencyKeys = exports.grantReward = exports.validateScore = exports.cleanupRateLimits = void 0;
 ...
 */
async function isRateLimited(uid, functionName) {
 ...
 */
exports.validateScore = functions
    .region('asia-northeast3')
        ...
        const result = await db.runTransaction(async (transaction) => {
            ...
            if (idempotencyKey) {
                ...
                if (existingInTransaction.exists) {
                    ...
                    return ((_a = existingInTransaction.data()) === null || _a === void 0 ? void 0 : _a.result) || { success: true, reason: 'ALREADY_PROCESSED' };
                }
            }
            ...
            switch (type) {
                case 'daily_login': {
                    ...
                    if (((_b = userData === null || userData === void 0 ? void 0 : userData.retention) === null || _b === void 0 ? void 0 : _b.lastClaimedDay) === today) {
                        return { success: false, reason: 'ALREADY_CLAIMED' };
                    }
                    // 7일 주기 보상
                    const dayOfWeek = ((((_c = userData === null || userData === void 0 ? void 0 : userData.retention) === null || _c === void 0 ? void 0 : _c.currentStreak) || 0) % 7) + 1;
                    const rewards = [
                ...
                case 'offline': {
                    const lastPlayDate = ((_d = userData === null || userData === void 0 ? void 0 : userData.retention) === null || _d === void 0 ? void 0 : _d.lastPlayDate) || Date.now();
 ...
 * 멱등성 키 정리 (매일 새벽 3시)
 */
exports.cleanupIdempotencyKeys = functions
    .region('asia-northeast3')
    .pubsub.schedule('0 3 * * *')
    .timeZone('Asia/Seoul')
    .onRun(async () => {
...
exports.updateLeaderboard = functions
    ...
    try {
        const result = await db.runTransaction(async (transaction) => {
            ...
            const currentScore = currentDoc.exists ? ((_a = currentDoc.data()) === null || _a === void 0 ? void 0 : _a.score) || 0 : 0;
            // 기존 점수보다 높을 때만 업데이트
        ...
        return Object.assign(Object.assign({}, result), { rank });
    }
    catch (error) {
 ...
 */
exports.resetWeeklyLeaderboard = functions
    .region('asia-northeast3')
 ...
 * 개별 사용자에게 푸시 알림 전송
 */
async function sendPushToUser(uid, messageType) {
    var _a;
    try {
 ...
 */
exports.sendD1RetentionPush = functions
    .region('asia-northeast3')
    ...
    console.log(`[D1 Push] 2h: ${twoHourUsers.size}, 4h: ${fourHourUsers.size}`);
    return null;
});
/**
 * D3-D5 리텐션 훅 (하루 한번 오전 10시)
 */
exports.sendD3D5RetentionPush = functions
    .region('asia-northeast3')
 ...
 */
exports.sendD7D14RetentionPush = functions
    .region('asia-northeast3')
 ...
 * 에너지 회복 완료 알림 (개별 트리거)
 */
exports.scheduleEnergyFullPush = functions
    .region('asia-northeast3')
    ...
    if (((_a = before === null || before === void 0 ? void 0 : before.energy) === null || _a === void 0 ? void 0 : _a.current) === 0 && ((_b = after === null || after === void 0 ? void 0 : after.energy) === null || _b === void 0 ? void 0 : _b.current) === 1) {
        const userId = context.params.userId;
        const maxEnergy = ((_c = after === null || after === void 0 ? void 0 : after.energy) === null || _c === void 0 ? void 0 : _c.max) || 5;
        const recoveryTimeMs = (((_d = after === null || after === void 0 ? void 0 : after.energy) === null || _d === void 0 ? void 0 : _d.recoveryMinutes) || 20) * 60 * 1000;
 ...
 * 예약된 푸시 알림 처리 (매분 실행)
 */
exports.processScheduledPushes = functions
    .region('asia-northeast3')
    .pubsub.schedule('* * * * *')
    .timeZone('Asia/Seoul')
    .onRun(async () => {
 ...
 * 스트릭 위험 알림 (매일 저녁 8시)
 */
exports.sendStreakDangerPush = functions
    .region('asia-northeast3')
 ...
 * 일일 보상 알림 (오전 9시)
 */
exports.sendDailyRewardPush = functions
    .region('asia-northeast3')
    .pubsub.schedule('0 9 * * *')
    .timeZone('Asia/Seoul')
    .onRun(async () => {
 ...
 */
exports.verifyIAPPurchase = functions
    .region('asia-northeast3')
    .https.onCall(async (data, context) => {
    if (!context.auth) {
        throw new functions.https.HttpsError('unauthenticated', '로그인이 필요합니다');
 ...
 */
async function verifyAppStoreReceipt(receipt, productId) {
